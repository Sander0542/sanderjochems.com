...
return [
    'about' => [
        ...
        'birthdate' => Carbon::parse('2001-06-07T00:00:00'),
    ...
    'educations' => [
        [
            ...
            'startedAt' => Carbon::parse('2020-02-01T00:00:00'),
            'endedAt' => Carbon::parse('2023-01-31T00:00:00')
        ],
        [
            'school' => 'Summa College',
            'study' => 'Computer Software and Media Applications',
            'degree' => 'MBO Level 4',
            'startedAt' => Carbon::parse('2017-08-01T00:00:00'),
            'endedAt' => Carbon::parse('2020-01-31T00:00:00')
        ],
        [
            'school' => 'Strabrecht College',
            'study' => 'Voortgezet middelbaar onderwijs (VMBO)',
            'degree' => 'High School Diploma',
            'startedAt' => Carbon::parse('2013-08-01T00:00:00'),
            'endedAt' => Carbon::parse('2017-07-31T00:00:00')
        ],
        [
            'school' => 'Nutsbasisschool de Ganzebloem',
            'study' => 'Basisonderwijs',
            'degree' => '',
            'startedAt' => Carbon::parse('2005-08-01T00:00:00'),
            'endedAt' => Carbon::parse('2013-07-31T00:00:00')
        ]
    ],
    'experiences' => [
        [
            ...
            'positions' => [
                [
                    ...
                    'startedAt' => Carbon::parse('2022-08-29T00:00:00'),
                    'endedAt' => Carbon::parse('2023-01-27T00:00:00')
                ]
            ]
        ],
        [
            ...
            'positions' => [
                [
                    ...
                    'type' => 'Contract',
                    'location' => 'Eindhoven Area, Netherlands',
                    'startedAt' => Carbon::parse('2019-08-31T00:00:00'),
                    'endedAt' => null
                ],
                [
                    ...
                    'type' => 'Self-employed',
                    'location' => 'Eindhoven Area, Netherlands',
                    'startedAt' => Carbon::parse('2017-07-01T00:00:00'),
                    'endedAt' => Carbon::parse('2019-08-30T00:00:00')
                ]
            ]
        ],
        [
            ...
            'positions' => [
                [
                    ...
                    'startedAt' => Carbon::parse('2019-08-01T00:00:00'),
                    'endedAt' => Carbon::parse('2019-12-31T00:00:00')
                ]
            ]
        ],
        [
            ...
            'positions' => [
                [
                    ...
                    'startedAt' => Carbon::parse('2018-08-01T00:00:00'),
                    'endedAt' => Carbon::parse('2019-02-01T00:00:00')
                ]
            ]
        ],
        [
            ...
            'positions' => [
                [
                    ...
                    'startedAt' => Carbon::parse('2017-03-01T00:00:00'),
                    'endedAt' => Carbon::parse('2018-08-31T00:00:00')
                ]
            ]
        ]
    ],
    'projects' => [
        [
            ...
            'startedAt' => Carbon::parse('2020-01-16T00:00:00'),
            'endedAt' => null
        ],
        [
            ...
            'startedAt' => Carbon::parse('2021-12-21T00:00:00'),
            'endedAt' => null
        ]
    ],
    'skills' => [
