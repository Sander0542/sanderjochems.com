            ...
            <div class="row">
                ...
                <div class="col-md-8 personal-profile">
                    ...
                    <p class="profile-social">
                        <a href="{{ config('personal.social.linkedin.url') }}" target="_blank" aria-label="Read more about {{ config('personal.about.name') }} on LinkedIn">
                        ...
                        <a href="{{ config('personal.social.github.url') }}" target="_blank" aria-label="Read more about {{ config('personal.about.name') }} on GitHub">
